...
## Project Structure
    ...
    ├── proxy_connector_demo_5  # Django project configurations
...
1. Clone this repo and `cd proxy_connector_demo_5`
...
2. Clone this repo and `cd proxy_connector_demo_5`
