"""
Django settings for proxy_connector_demo_5 project.
...
ROOT_URLCONF = 'proxy_connector_demo_5.urls'
...
WSGI_APPLICATION = 'proxy_connector_demo_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "proxy_connector_demo_5 API",
    "DESCRIPTION": "API documentation for proxy_connector_demo_5 App",
    "VERSION": "v1",
}
